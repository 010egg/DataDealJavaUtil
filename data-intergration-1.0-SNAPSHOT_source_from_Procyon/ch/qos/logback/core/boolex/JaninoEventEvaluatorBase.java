...
public abstract class JaninoEventEvaluatorBase<E> extends EventEvaluatorBase<E>
{
    ...
    public void start() {
        try {
            ...
            this.scriptEvaluator = new ScriptEvaluator(this.getDecoratedExpression(), (Class)JaninoEventEvaluatorBase.EXPRESSION_TYPE, this.getParameterNames(), (Class[])this.getParameterTypes(), (Class[])JaninoEventEvaluatorBase.THROWN_EXCEPTIONS);
            super.start();
        }
        catch (Exception e) {
    ...
    static {
        ...
        (JaninoEventEvaluatorBase.THROWN_EXCEPTIONS = (Class<?>[])new Class[1])[0] = EvaluationException.class;
    }
}
