...
public class StringToObjectConverter
{
    ...
    private static boolean followsTheValueOfConvention(final Class<?> parameterClass) {
        try {
            final Method valueOfMethod = parameterClass.getMethod("valueOf", StringToObjectConverter.STING_CLASS_PARAMETER);
    ...
    private static Object convertByValueOfMethod(final ContextAware ca, final Class<?> type, final String val) {
        try {
            final Method valueOfMethod = type.getMethod("valueOf", StringToObjectConverter.STING_CLASS_PARAMETER);
