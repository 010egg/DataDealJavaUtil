...
public abstract class JoranConfiguratorBase extends GenericConfigurator
{
    ...
    protected void addInstanceRules(final RuleStore rs) {
        ...
        rs.addRule(new ElementSelector("configuration/appender/appender-ref"), new AppenderRefAction<Object>());
    ...
    protected void addImplicitRules(final Interpreter interpreter) {
        final NestedComplexPropertyIA nestedComplexPropertyIA = new NestedComplexPropertyIA(this.getBeanDescriptionCache());
        nestedComplexPropertyIA.setContext(this.context);
        interpreter.addImplicitAction(nestedComplexPropertyIA);
        final NestedBasicPropertyIA nestedBasicIA = new NestedBasicPropertyIA(this.getBeanDescriptionCache());
