...
public class JoranConfigurator extends JoranConfiguratorBase
{
    public void addInstanceRules(final RuleStore rs) {
        ...
        rs.addRule(new ElementSelector("configuration/logger/appender-ref"), new AppenderRefAction<Object>());
        rs.addRule(new ElementSelector("configuration/root/appender-ref"), new AppenderRefAction<Object>());
