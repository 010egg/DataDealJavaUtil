...
{
    public static Map fromBytes(final byte[] b, final Encoding encoding) throws SQLException {
    ...
    public static byte[] toBytes(final Map m, final Encoding encoding) throws SQLException {
        ...
        try {
            ...
            for (final Map.Entry e : m.entrySet()) {
                final byte[] key = encoding.encode(e.getKey().toString());
    ...
    public static Map fromString(final String s) {
        final Map m = new HashMap();
        int pos = 0;
