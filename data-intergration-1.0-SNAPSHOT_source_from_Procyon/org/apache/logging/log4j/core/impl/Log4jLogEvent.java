...
public class Log4jLogEvent implements LogEvent
{
    ...
    public Log4jLogEvent() {
        this("", null, "", null, null, null, null, null, null, 0L, null, 0, null, Log4jLogEvent.CLOCK.currentTimeMillis(), Log4jLogEvent.nanoClock.nanoTime());
    }
    
    @Deprecated
    public Log4jLogEvent(final long timestamp) {
        this("", null, "", null, null, null, null, null, null, 0L, null, 0, null, timestamp, Log4jLogEvent.nanoClock.nanoTime());
    }
    ...
    static class LogEventProxy implements Serializable
    {
        ...
        public LogEventProxy(final LogEvent event, final boolean includeLocation) {
            ...
            this.message = ((msg instanceof ReusableMessage) ? memento((ReusableMessage)msg) : msg);
