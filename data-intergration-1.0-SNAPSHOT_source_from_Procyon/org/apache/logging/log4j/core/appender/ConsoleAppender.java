...
public final class ConsoleAppender extends AbstractOutputStreamAppender<OutputStreamManager>
{
    ...
    public static ConsoleAppender createDefaultAppenderForLayout(final Layout<? extends Serializable> layout) {
        return new ConsoleAppender("DefaultConsole-" + ConsoleAppender.COUNT.incrementAndGet(), layout, null, getDefaultManager(ConsoleAppender.DEFAULT_TARGET, false, false, layout), true, ConsoleAppender.DEFAULT_TARGET);
    }
