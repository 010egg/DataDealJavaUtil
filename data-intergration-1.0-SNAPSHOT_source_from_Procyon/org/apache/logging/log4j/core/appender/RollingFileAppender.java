    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B> implements org.apache.logging.log4j.core.util.Builder<RollingFileAppender>
    {
        ...
        public RollingFileAppender build() {
            ...
            if (this.fileName == null) {
                RollingFileAppender.LOGGER.error("RollingFileAppender '{}': No file name provided.", this.getName());
                return null;
            }
            ...
            if (this.strategy == null) {
                this.strategy = DefaultRolloverStrategy.createStrategy(null, null, null, String.valueOf(-1), null, true, this.configuration);
            }
            if (this.strategy == null) {
                this.strategy = DefaultRolloverStrategy.createStrategy(null, null, null, String.valueOf(-1), null, true, this.configuration);
            }
            final Layout<? extends Serializable> layout = this.getOrCreateLayout();
            final RollingFileManager manager = RollingFileManager.getFileManager(this.fileName, this.filePattern, this.append, isBufferedIo, this.policy, this.strategy, this.advertiseUri, layout, bufferSize, this.isImmediateFlush(), this.createOnDemand, this.configuration);
            if (manager == null) {
                return null;
            }
            manager.initialize();
            return new RollingFileAppender(this.getName(), layout, this.getFilter(), manager, this.fileName, this.filePattern, this.isIgnoreExceptions(), this.isImmediateFlush(), this.advertise ? this.configuration.getAdvertiser() : null, null);
        }
