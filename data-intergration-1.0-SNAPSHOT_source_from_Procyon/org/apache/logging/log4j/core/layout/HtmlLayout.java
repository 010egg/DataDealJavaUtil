...
public final class HtmlLayout extends AbstractStringLayout
{
    ...
    public byte[] getHeader() {
        ...
        sbuf.append("<meta charset=\"").append(this.getCharset()).append("\"/>").append(Strings.LINE_SEPARATOR);
        sbuf.append("<title>").append(this.title).append("</title>").append(Strings.LINE_SEPARATOR);
        ...
        sbuf.append(this.headerSize).append(";}").append(Strings.LINE_SEPARATOR);
        ...
        sbuf.append("Log session start time " + new Date() + "<br>").append(Strings.LINE_SEPARATOR);
