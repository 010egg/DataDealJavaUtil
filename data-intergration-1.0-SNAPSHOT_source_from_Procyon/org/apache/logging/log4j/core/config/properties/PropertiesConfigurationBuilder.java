...
public class PropertiesConfigurationBuilder extends ConfigurationBuilderFactory implements Builder<PropertiesConfiguration>
{
    ...
    public PropertiesConfiguration build() {
        ...
        this.builder.setStatusLevel(Level.toLevel(this.rootProperties.getProperty("status"), Level.ERROR)).setShutdownHook(this.rootProperties.getProperty("shutdownHook")).setVerbosity(this.rootProperties.getProperty("verbose")).setDestination(this.rootProperties.getProperty("dest")).setPackages(this.rootProperties.getProperty("packages")).setConfigurationName(this.rootProperties.getProperty("name")).setMonitorInterval(this.rootProperties.getProperty("monitorInterval", "0")).setAdvertiser(this.rootProperties.getProperty("advertiser"));
        ...
        if (filterProp != null) {
            final String[] arr$;
            final String[] filterNames = arr$ = filterProp.split(",");
            for (final String filterName : arr$) {
        ...
        if (appenderProp != null) {
            final String[] arr$2;
            final String[] appenderNames = arr$2 = appenderProp.split(",");
            for (final String appenderName : arr$2) {
        ...
        if (loggerProp != null) {
            final String[] arr$3;
            final String[] loggerNames = arr$3 = loggerProp.split(",");
            for (final String loggerName : arr$3) {
