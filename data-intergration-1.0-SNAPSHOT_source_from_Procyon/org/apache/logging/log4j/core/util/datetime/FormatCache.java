...
abstract class FormatCache<F extends Format>
{
    ...
    static String getPatternForStyle(final Integer dateStyle, final Integer timeStyle, final Locale locale) {
        ...
        String pattern = FormatCache.DATETIME_INSTANCE_CACHE.get(key);
        if (pattern == null) {
            try {
                ...
                final String previous = FormatCache.DATETIME_INSTANCE_CACHE.putIfAbsent(key, pattern);
                if (previous != null) {
                    pattern = previous;
                }
            }
    ...
    static {
        DATETIME_INSTANCE_CACHE = new ConcurrentHashMap<MultipartKey, String>(7);
    }
    ...
    private static class MultipartKey
    {
        ...
        public boolean equals(final Object obj) {
            return obj != null && Arrays.equals(this.keys, ((MultipartKey)obj).keys);
        }
