...
{
    public static final BigDecimalJsonFormats$ MODULE$;
    ...
    private BigDecimalWriters.FloatWriter$ FloatWriter$lzycompute() {
        synchronized (this) {
            if (this.FloatWriter$module == null) {
                this.FloatWriter$module = new BigDecimalWriters.FloatWriter$(this);
            }
    ...
    private BigDecimalWriters.DoubleWriter$ DoubleWriter$lzycompute() {
        synchronized (this) {
            if (this.DoubleWriter$module == null) {
                this.DoubleWriter$module = new BigDecimalWriters.DoubleWriter$(this);
            }
            final BoxedUnit unit = BoxedUnit.UNIT;
    ...
    private BigDecimalWriters.BigDecimalWriter$ BigDecimalWriter$lzycompute() {
        synchronized (this) {
            if (this.BigDecimalWriter$module == null) {
                this.BigDecimalWriter$module = new BigDecimalWriters.BigDecimalWriter$(this);
            }
            final BoxedUnit unit = BoxedUnit.UNIT;
    ...
    private BigDecimalJsonFormats$() {
        ...
        BigDecimalWriters$class.$init$(this);
    }
}
