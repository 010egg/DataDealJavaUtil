...
public final class TypeFactory implements Serializable
{
            ...
            if (baseType.getBindings().isEmpty()) {
                ...
                if (typeParamCount == 0) {
                    ...
                    if (baseType.isInterface()) {
                        ...
                        newType = baseType.refine(subclass, tb, baseType, TypeFactory.NO_TYPES);
                    }
                    if (newType == null) {
    ...
    private TypeBindings _bindingsForSubtype(final JavaType baseType, final int typeParamCount, final Class<?> subclass) {
        final int baseCount = baseType.containedTypeCount();
        ...
        final List<JavaType> types = new ArrayList<JavaType>(baseCount);
