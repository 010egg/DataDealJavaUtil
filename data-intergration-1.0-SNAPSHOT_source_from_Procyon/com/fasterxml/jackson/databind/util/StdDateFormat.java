...
public class StdDateFormat extends DateFormat
{
    ...
    public StdDateFormat withLenient(final Boolean b) {
        ...
        return new StdDateFormat(this._timezone, this._locale, b);
    }
    ...
    protected static void _format(final TimeZone tz, final Locale loc, final Date date, final StringBuffer buffer) {
    ...
    protected Date _parseAsISO8601(final String dateStr, final ParsePosition pos) throws IllegalArgumentException, ParseException {
        ...
        final Calendar cal = new GregorianCalendar(tz, this._locale);
