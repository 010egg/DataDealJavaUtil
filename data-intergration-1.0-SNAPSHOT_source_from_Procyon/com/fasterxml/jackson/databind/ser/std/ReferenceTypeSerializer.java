...
public abstract class ReferenceTypeSerializer<T> extends StdSerializer<T> implements ContextualSerializer
{
    ...
    private final JsonSerializer<Object> _findCachedSerializer(final SerializerProvider provider, final Class<?> type) throws JsonMappingException {
    ...
    private final JsonSerializer<Object> _findSerializer(final SerializerProvider provider, final Class<?> type, final BeanProperty prop) throws JsonMappingException {
