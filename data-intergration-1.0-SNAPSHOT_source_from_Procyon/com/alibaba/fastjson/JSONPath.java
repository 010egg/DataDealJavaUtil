...
public class JSONPath implements JSONAware
{
    ...
    public void patchAdd(final Object rootObject, final Object value, final boolean replace) {
        if (rootObject == null) {
            return;
        }
        this.init();
        ...
        if (result != null && !replace) {
            ...
            if (resultClass.isArray()) {
                ...
                final Object descArray = Array.newInstance(resultClass.getComponentType(), length + 1);
    ...
    private static void paths(final Map<Object, String> values, final Map<String, Object> paths, final String parent, final Object javaObject, final SerializeConfig config) {
        ...
        if (p != null) {
            ...
            final boolean basicType = type == String.class || type == Boolean.class || type == Character.class || type == UUID.class || type.isEnum() || javaObject instanceof Number || javaObject instanceof Date;
            if (!basicType) {
                return;
            }
        }
    ...
    protected boolean setPropertyValue(final Object parent, final String name, final long propertyNameHash, Object value) {
            ...
            if (predicateFlag || IOUtils.firstIdentifier(this.ch) || Character.isJavaIdentifierStart(this.ch) || this.ch == '\\' || this.ch == '@') {
                ...
                if (acceptBracket && this.ch == ']') {
                    ...
                    if (op == Operator.BETWEEN || op == Operator.NOT_BETWEEN) {
                        ...
                        if (JSONPath.isInt(startValue.getClass()) && JSONPath.isInt(endValue.getClass())) {
                            final Filter filter2 = new IntBetweenSegement(propertyName, function, TypeUtils.longExtractValue((Number)startValue), TypeUtils.longExtractValue((Number)endValue), not);
                            return filter2;
                        }
                        throw new JSONPathException(this.path);
                    }
                        ...
                        if (valueList.size() == 1 && valueList.get(0) == null) {
                            Filter filter3;
                            if (not) {
                                filter3 = new NotNullSegement(propertyName, function);
                            }
                            else {
                                filter3 = new NullSegement(propertyName, function);
                            }
                            while (this.ch == ' ') {
                                this.next();
                            }
                        ...
                        if (isInt) {
                            if (valueList.size() == 1) {
                                ...
                                Filter filter4 = new IntOpSegement(propertyName, function, value2, intOp);
                                while (this.ch == ' ') {
                                    this.next();
                                }
                                if (this.ch == '&' || this.ch == '|') {
                            ...
                            Filter filter5 = new IntInSegement(propertyName, function, values, not);
                            while (this.ch == ' ') {
                                this.next();
                            }
                            if (this.ch == '&' || this.ch == '|') {
                            ...
                            if (valueList.size() == 1) {
                                ...
                                Filter filter6 = new StringOpSegement(propertyName, function, value3, intOp2);
                                while (this.ch == ' ') {
                                    this.next();
                                }
                                if (this.ch == '&' || this.ch == '|') {
                            ...
                            Filter filter5 = new StringInSegement(propertyName, function, values2, not);
                            while (this.ch == ' ') {
                                this.next();
                            }
                            if (this.ch == '&' || this.ch == '|') {
                            ...
                            if (isIntObj) {
                                ...
                                Filter filter5 = new IntObjInSegement(propertyName, function, values3, not);
                                while (this.ch == ' ') {
                                    this.next();
                                }
                                if (this.ch == '&' || this.ch == '|') {
                        ...
                        if (this.ch == '\'' || this.ch == '\"') {
                            ...
                            if (op == Operator.RLIKE) {
                                filter7 = new RlikeSegement(propertyName, function, strValue, false);
                            }
                            else if (op == Operator.NOT_RLIKE) {
                                filter7 = new RlikeSegement(propertyName, function, strValue, true);
                            }
                                ...
                                if (p0 == -1) {
                                    ...
                                    filter7 = new StringOpSegement(propertyName, function, strValue, op);
                                }
                                else {
                                    ...
                                    filter7 = new MatchSegement(propertyName, function, startsWithValue, endsWithValue, containsValues, not2);
                                }
                            }
                            else {
                                filter7 = new StringOpSegement(propertyName, function, strValue, op);
                        ...
                        if (isDigitFirst(this.ch)) {
                            ...
                            Filter filter2;
                            if (doubleValue == 0.0) {
                                filter2 = new IntOpSegement(propertyName, function, value4, op);
                            }
                            else {
                                filter2 = new DoubleOpSegement(propertyName, function, doubleValue, op);
                            }
                            while (this.ch == ' ') {
                                this.next();
                            }
                        ...
                        if (this.ch == '$') {
                            ...
                            final RefOpSegement filter8 = new RefOpSegement(propertyName, function, segment, op);
                        ...
                        if (this.ch == '/') {
                            ...
                            final RegMatchSegement filter9 = new RegMatchSegement(propertyName, function, pattern, op);
                            if (predicateFlag) {
                                this.accept(')');
                            }
                            if (acceptBracket) {
                        ...
                        if (this.ch == 'n') {
                            ...
                            if ("null".equals(name2)) {
                                Filter filter7 = null;
                                if (op == Operator.EQ) {
                                    filter7 = new NullSegement(propertyName, function);
                                }
                                else if (op == Operator.NE) {
                                    filter7 = new NotNullSegement(propertyName, function);
                                }
                                if (filter7 != null) {
                                    while (this.ch == ' ') {
                                        this.next();
                            ...
                            if ("true".equals(name2)) {
                                Filter filter7 = null;
                                if (op == Operator.EQ) {
                                    filter7 = new ValueSegment(propertyName, function, Boolean.TRUE, true);
                                }
                                else if (op == Operator.NE) {
                                    filter7 = new ValueSegment(propertyName, function, Boolean.TRUE, false);
                                }
                                if (filter7 != null) {
                                    while (this.ch == ' ') {
                                        this.next();
                            ...
                            if ("false".equals(name2)) {
                                Filter filter7 = null;
                                if (op == Operator.EQ) {
                                    filter7 = new ValueSegment(propertyName, function, Boolean.FALSE, true);
                                }
                                else if (op == Operator.NE) {
                                    filter7 = new ValueSegment(propertyName, function, Boolean.FALSE, false);
                                }
                                if (filter7 != null) {
                                    while (this.ch == ' ') {
                                        this.next();
                ...
                if (text.indexOf(92) != 0) {
                    ...
                    for (int j = 0; j < text.length(); ++j) {
                        ...
                        if (ch == '\\' && j < text.length() - 1) {
                            final char c2 = text.charAt(j + 1);
                            if (c2 == '@' || ch == '\\' || ch == '\"') {
                                buf.append(c2);
                                ++j;
                                continue;
                ...
                final Segment segment = this.buildArraySegement(text);
    ...
    static class TypeSegment implements Segment
    {
        ...
        public String eval(final JSONPath path, final Object rootObject, final Object currentObject) {
            if (currentObject == null) {
                return "null";
            }
            if (currentObject instanceof Collection) {
    ...
    static class FloorSegment implements Segment
    {
        ...
        public Object eval(final JSONPath path, final Object rootObject, final Object currentObject) {
            if (currentObject instanceof JSONArray) {
                final JSONArray array = (JSONArray)((JSONArray)currentObject).clone();
                for (int i = 0; i < array.size(); ++i) {
                    final Object item = array.get(i);
                    final Object newItem = floor(item);
                    if (newItem != item) {
                        array.set(i, newItem);
                    }
                }
        ...
        private static Object floor(final Object item) {
            if (item == null) {
                return null;
            }
    ...
    {
        public NotNullSegement(final String propertyName, final boolean function) {
    ...
    {
        public NullSegement(final String propertyName, final boolean function) {
            super(propertyName, function);
        }
        
        public boolean apply(final JSONPath path, final Object rootObject, final Object currentObject, final Object item) {
            final Object propertyValue = this.get(path, rootObject, item);
    ...
    static class ValueSegment extends PropertyFilter
    {
        ...
        public ValueSegment(final String propertyName, final boolean function, final Object value, final boolean eq) {
            super(propertyName, function);
            this.eq = true;
            if (value == null) {
    ...
    static class IntInSegement extends PropertyFilter
    {
        ...
        public IntInSegement(final String propertyName, final boolean function, final long[] values, final boolean not) {
            super(propertyName, function);
            this.values = values;
            this.not = not;
        }
    ...
    static class IntBetweenSegement extends PropertyFilter
    {
        ...
        public IntBetweenSegement(final String propertyName, final boolean function, final long startValue, final long endValue, final boolean not) {
            super(propertyName, function);
    ...
    static class IntObjInSegement extends PropertyFilter
    {
        ...
        public IntObjInSegement(final String propertyName, final boolean function, final Long[] values, final boolean not) {
            super(propertyName, function);
            this.values = values;
            this.not = not;
        }
    ...
    static class StringInSegement extends PropertyFilter
    {
        ...
        public StringInSegement(final String propertyName, final boolean function, final String[] values, final boolean not) {
            super(propertyName, function);
            this.values = values;
            this.not = not;
        }
    ...
    static class IntOpSegement extends PropertyFilter
    {
        ...
        public IntOpSegement(final String propertyName, final boolean function, final long value, final Operator op) {
            super(propertyName, function);
            this.value = value;
            this.op = op;
        }
    ...
    abstract static class PropertyFilter implements Filter
    {
        ...
        protected PropertyFilter(final String propertyName, final boolean function) {
            this.propertyName = propertyName;
            this.propertyNameHash = TypeUtils.fnv1a_64(propertyName);
            this.function = function;
            if (function) {
                if (this.propertyNameHash == PropertyFilter.TYPE) {
        ...
        protected Object get(final JSONPath path, final Object rootObject, final Object currentObject) {
        ...
        static {
            PropertyFilter.TYPE = TypeUtils.fnv1a_64("type");
        }
    }
    ...
    static class DoubleOpSegement extends PropertyFilter
    {
        ...
        public DoubleOpSegement(final String propertyName, final boolean function, final double value, final Operator op) {
            super(propertyName, function);
            this.value = value;
            this.op = op;
        }
    ...
    static class RefOpSegement extends PropertyFilter
    {
        ...
        public RefOpSegement(final String propertyName, final boolean function, final Segment refSgement, final Operator op) {
            super(propertyName, function);
    ...
    static class MatchSegement extends PropertyFilter
    {
        ...
        public MatchSegement(final String propertyName, final boolean function, final String startsWithValue, final String endsWithValue, final String[] containsValues, final boolean not) {
            super(propertyName, function);
    ...
    static class RlikeSegement extends PropertyFilter
    {
        ...
        public RlikeSegement(final String propertyName, final boolean function, final String pattern, final boolean not) {
            super(propertyName, function);
    ...
    static class StringOpSegement extends PropertyFilter
    {
        ...
        public StringOpSegement(final String propertyName, final boolean function, final String value, final Operator op) {
            super(propertyName, function);
            this.value = value;
            this.op = op;
        }
    ...
    static class RegMatchSegement extends PropertyFilter
    {
        ...
        public RegMatchSegement(final String propertyName, final boolean function, final Pattern pattern, final Operator op) {
            super(propertyName, function);
