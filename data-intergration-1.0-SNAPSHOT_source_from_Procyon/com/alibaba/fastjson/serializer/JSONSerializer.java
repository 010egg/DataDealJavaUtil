...
public class JSONSerializer extends SerializeFilterable
{
    ...
    private DateFormat generateDateFormat(final String dateFormatPattern) {
        final DateFormat dateFormat = new SimpleDateFormat(dateFormatPattern, this.locale);
    ...
    public void setFastJsonConfigDateFormatPattern(final String dateFormatPattern) {
        ...
        if (object instanceof Date) {
            ...
            if (dateFormat == null) {
                if (format != null) {
                    ...
                    dateFormat = this.generateDateFormat(this.fastJsonConfigDateFormatPattern);
                }
                else {
