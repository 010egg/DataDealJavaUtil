...
public class SerializeConfig
{
    ...
    public ObjectSerializer createJavaBeanSerializer(final SerializeBeanInfo beanInfo) {
        ...
        if (asm) {
            try {
                ...
                throw new JSONException("create asm serializer error, verson 1.2.75, class " + clazz, e2);
            }
        }
        return new JavaBeanSerializer(beanInfo);
    }
    ...
    public ObjectSerializer getObjectWriter(final Class<?> clazz, final boolean create) {
        ...
        if (writer == null) {
            ...
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                final Class mixedInType = (Class)JSON.getMixInAnnotations(clazz);
                JSONType jsonType;
                if (mixedInType != null) {
                ...
                if (jsonType != null && jsonType.serializeEnumAsJavaBean()) {
                    ...
                    Member member = null;
                    if (mixedInType != null) {
                        final Member mixedInMember = getEnumValueField(mixedInType);
                        if (mixedInMember != null) {
                            try {
                                if (mixedInMember instanceof Method) {
                                    final Method mixedInMethod = (Method)mixedInMember;
                    ...
                    if (member != null) {
                        this.put(clazz, writer = new EnumSerializer(member));
                    }
                    else {
                        this.put(clazz, writer = this.getEnumSerializer());
                    }
                }
            }
            else {
                ...
                if ((superClass = clazz.getSuperclass()) != null && superClass.isEnum()) {
                    final JSONType jsonType2 = TypeUtils.getAnnotation(superClass, JSONType.class);
                    ...
                    if (className.equals("org.json.JSONObject")) {
                        this.put(clazz, writer = JSONObjectCodec.instance);
                        return writer;
                    }
    ...
    private static Member getEnumValueField(final Class clazz) {
        Member member = null;
