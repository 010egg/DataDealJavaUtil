...
public final class SerializeWriter extends Writer
{
    ...
    public void writeFieldValue(final char seperator, final String name, final boolean value) {
        ...
        if (value) {
            System.arraycopy(SerializeWriter.VALUE_TRUE, 0, this.buf, nameEnd + 2, 5);
        }
        else {
            System.arraycopy(SerializeWriter.VALUE_FALSE, 0, this.buf, nameEnd + 2, 6);
        }
    }
