...
public final class JSONScanner extends JSONLexerBase
{
    ...
    public String scanFieldString(final char[] fieldName) {
        ...
        if (stringVal.indexOf(92) != -1) {
            ...
            final int chars_len = endIndex - (this.bp + fieldName.length + 1 + spaceCount);
            final char[] chars = this.sub_chars(this.bp + fieldName.length + 1 + spaceCount, chars_len);
            stringVal = JSONLexerBase.readString(chars, chars_len);
        }
        if ((this.features & Feature.TrimStringFieldValue.mask) != 0x0) {
