...
public class DefaultJSONParser implements Closeable
{
    ...
    static {
        ...
        final Class<?>[] classes = (Class<?>[])new Class[] { Boolean.TYPE, Byte.TYPE, Short.TYPE, Integer.TYPE, Long.TYPE, Float.TYPE, Double.TYPE, Boolean.class, Byte.class, Short.class, Integer.class, Long.class, Float.class, Double.class, BigInteger.class, BigDecimal.class, String.class };
        DefaultJSONParser.primitiveClasses.addAll(Arrays.asList(classes));
    }
