...
public class MapDeserializer extends ContextObjectDeserializer implements ObjectDeserializer
{
    ...
    protected Object deserialze(final DefaultJSONParser parser, final Type type, final Object fieldName, final Map map, final int features) {
        ...
        if (String.class == keyType) {
            return parseMap(parser, map, valueType, fieldName, features);
        }
    ...
    public static Map parseMap(final DefaultJSONParser parser, final Map<String, Object> map, final Type valueType, final Object fieldName, final int features) {
        final JSONLexer lexer = parser.lexer;
