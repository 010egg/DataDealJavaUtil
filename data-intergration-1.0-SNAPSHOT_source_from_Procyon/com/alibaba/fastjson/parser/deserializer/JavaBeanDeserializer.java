...
public class JavaBeanDeserializer implements ObjectDeserializer
{
    ...
    protected <T> T deserialze(final DefaultJSONParser parser, final Type type, final Object fieldName, Object object, final int features, int[] setFlags) {
        ...
        try {
            ...
            if (token != 12 && token != 16) {
                ...
                buf.append(", fastjson-version ").append("1.2.75");
                ...
                while (true) {
                    ...
                    Label_2991: {
                        if (fieldDeserializer != null) {
                            ...
                            else if (fieldClass.isEnum() && parser.getConfig().getDeserializer(fieldClass) instanceof EnumDeserializer && (fieldAnnotation == null || fieldAnnotation.deserializeUsing() == Void.class)) {
                                if (fieldDeserializer instanceof DefaultFieldDeserializer) {
                                    final ObjectDeserializer fieldValueDeserilizer = ((DefaultFieldDeserializer)fieldDeserializer).fieldValueDeserilizer;
                        ...
                        if (matchField) {
                            if (!valueParsed) {
                                ...
                                if (object == null) {
                                    ...
                                    if (fieldClass == String.class && ((features & Feature.TrimStringFieldValue.mask) != 0x0 || (this.beanInfo.parserFeatures & Feature.TrimStringFieldValue.mask) != 0x0 || (fieldInfo.parserFeatures & Feature.TrimStringFieldValue.mask) != 0x0)) {
                    ...
                    if (this.beanInfo.creatorConstructor != null) {
                        ...
                        if (paramNames != null) {
                            for (final Map.Entry<String, Object> entry : fieldValues.entrySet()) {
                                final FieldDeserializer fieldDeserializer2 = this.getFieldDeserializer(entry.getKey());
                                if (fieldDeserializer2 != null) {
                                    fieldDeserializer2.setValue(object, entry.getValue());
                                }
                            }
                        }
                    }
    ...
    public boolean parseField(final DefaultJSONParser parser, final String key, final Object object, final Type objectType, final Map<String, Object> fieldValues, final int[] setFlags) {
        ...
        else if (lexer.isEnabled(initStringFieldAsEmpty) || (this.beanInfo.parserFeatures & initStringFieldAsEmpty) != 0x0) {
    ...
    public FieldDeserializer smartMatch(final String key, final int[] setFlags) {
        ...
        if (fieldDeserializer == null) {
            ...
            if (pos < 0) {
                final long smartKeyHash2 = TypeUtils.fnv1a_64_extract(key);
            ...
            if (pos >= 0) {
                if (this.smartMatchHashArrayMapping == null) {
                    ...
                    Arrays.fill(mapping, (short)(-1));
                    for (int j = 0; j < this.sortedFieldDeserializers.length; ++j) {
                        final int p = Arrays.binarySearch(this.smartMatchHashArray, this.sortedFieldDeserializers[j].fieldInfo.nameHashCode);
                        if (p >= 0) {
                            mapping[p] = (short)j;
                        }
                    }
    ...
    public Object createInstance(final Map<String, Object> map, final ParserConfig config) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
            ...
            if (this.beanInfo.creatorConstructor != null) {
                ...
                if (this.beanInfo.kotlin) {
                    for (int j = 0; j < params.length; ++j) {
                        ...
                        if (param == null) {
                            if (this.beanInfo.fields != null && j < this.beanInfo.fields.length) {
                                final FieldInfo fieldInfo2 = this.beanInfo.fields[j];
                        ...
                        else if (param.getClass() != this.beanInfo.fields[j].fieldClass) {
                            params[j] = TypeUtils.cast(param, this.beanInfo.fields[j].fieldClass, config);
                        }
                    }
                }
                if (hasNull && this.beanInfo.kotlinDefaultConstructor != null) {
        ...
        for (final Map.Entry<String, Object> entry2 : map.entrySet()) {
            ...
            final Class<?> fieldClass2 = fieldInfo.fieldClass;
            final JSONField fieldAnnation = fieldInfo.getAnnotation();
            if (fieldInfo.declaringClass != null && (!fieldClass2.isInstance(value2) || (fieldAnnation != null && fieldAnnation.deserializeUsing() != Void.class))) {
                ...
                if (format != null && paramType == Date.class) {
                    ...
                    value2 = Jdk8DateCodec.castToLocalDateTime(value2, format);
                }
