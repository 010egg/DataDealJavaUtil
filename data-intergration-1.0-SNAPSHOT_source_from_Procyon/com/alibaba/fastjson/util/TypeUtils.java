...
public class TypeUtils
{
                ...
                if (!Modifier.isStatic(method.getModifiers())) {
                    ...
                    if (!returnType.equals(Void.TYPE)) {
                        if (method.getParameterTypes().length == 0) {
                            if (returnType != ClassLoader.class && returnType != InputStream.class) {
                                            ...
                                            if (!kotlin || !isKotlinIgnore(clazz, methodName)) {
                                                ...
                                                if (annotation == null && kotlin) {
                                                    if (constructors == null) {
                                                        ...
                                                        final Constructor creatorConstructor = getKotlinConstructor(constructors);
                                                ...
                                                if (methodName.startsWith("get")) {
                                                    ...
                                                    if (Character.isUpperCase(c3) || c3 > '\u0200') {
                                                        if (TypeUtils.compatibleWithJavaBean) {
                                                            ...
                                                            propertyName2 = getPropertyNameByMethodName(methodName);
                                                        }
    ...
    public static String getPropertyNameByMethodName(final String methodName) {
    ...
    public static Collection createCollection(final Type type) {
        ...
        else if (rawClass.isAssignableFrom(Queue.class) || (TypeUtils.class_deque != null && rawClass.isAssignableFrom(TypeUtils.class_deque))) {
            list = new LinkedList();
        }
        else {
            try {
    ...
    public static long fnv1a_64_extract(final String key) {
    ...
    public static Constructor getKotlinConstructor(final Constructor[] constructors) {
        return getKotlinConstructor(constructors, null);
    }
    
    public static Constructor getKotlinConstructor(final Constructor[] constructors, final String[] paramNames) {
    ...
    public static <A extends Annotation> A getAnnotation(final Class<?> targetClass, final Class<A> annotationClass) {
        ...
        if (mixInClass != null) {
            ...
            final Annotation[] annotations = mixInClass.getAnnotations();
        ...
        final Annotation[] targetClassAnnotations = targetClass.getAnnotations();
        if (targetAnnotation == null && targetClassAnnotations.length > 0) {
            for (final Annotation annotation2 : targetClassAnnotations) {
    ...
    static {
        ...
        try {
            TypeUtils.class_deque = Class.forName("java.util.Deque");
        }
        catch (Throwable t2) {}
        addBaseClassMappings();
    }
