...
public final class Type
{
    ...
    static Type getTypeInternal(final String descriptorBuffer, final int descriptorBegin, final int descriptorEnd) {
        switch (descriptorBuffer.charAt(descriptorBegin)) {
            ...
            case 'L': {
                final int len = descriptorEnd - descriptorBegin;
                switch (len) {
                    case 16: {
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_LIST.valueBuffer, 0, len)) {
                            return Type.TYPE_LIST;
                        }
                        break;
                    }
                    case 17: {
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_CLASS.valueBuffer, 0, len)) {
                            return Type.TYPE_CLASS;
                        }
                        break;
                    }
                    case 18: {
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_STRING.valueBuffer, 0, len)) {
                            return Type.TYPE_STRING;
                        }
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_OBJECT.valueBuffer, 0, len)) {
                            return Type.TYPE_OBJECT;
                        }
                        break;
                    }
                    case 24: {
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_TYPE.valueBuffer, 0, len)) {
                            return Type.TYPE_TYPE;
                        }
                        break;
                    }
                    case 29: {
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_SUPPLIER.valueBuffer, 0, len)) {
                            return Type.TYPE_SUPPLIER;
                        }
                        break;
                    }
                    case 34: {
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_JSON_WRITER.valueBuffer, 0, len)) {
                            return Type.TYPE_JSON_WRITER;
                        }
                        if (descriptorBuffer.regionMatches(descriptorBegin, Type.TYPE_JSON_READER.valueBuffer, 0, len)) {
                            return Type.TYPE_JSON_READER;
                        }
                        break;
                    }
                }
    ...
    public String getDescriptor() {
        if (this.sort == 10) {
            ...
            final String valueBuffer2 = this.valueBuffer;
            switch (valueBuffer2) {
                case "VZCBSIFJD": {
    ...
    public String getClassName() {
        switch (this.sort) {
            ...
            case 9: {
                final Type elementType = getTypeInternal(this.valueBuffer, this.valueBegin + this.getDimensions(), this.valueEnd);
                final StringBuilder stringBuilder = new StringBuilder(elementType.getClassName());
    ...
    static {
        ...
        TYPE_CLASS = new Type(10, "Ljava/lang/Class;", 1, 16);
        TYPE_TYPE = new Type(10, "Ljava/lang/reflect/Type;", 1, 23);
        TYPE_OBJECT = new Type(10, "Ljava/lang/Object;", 1, 17);
        TYPE_STRING = new Type(10, "Ljava/lang/String;", 1, 17);
        TYPE_LIST = new Type(10, "Ljava/util/List;", 1, 15);
        TYPE_JSON_READER = new Type(10, "Lcom/alibaba/fastjson2/JSONReader;", 1, 33);
        TYPE_JSON_WRITER = new Type(10, "Lcom/alibaba/fastjson2/JSONWriter;", 1, 33);
        TYPE_SUPPLIER = new Type(10, "Ljava/util/function/Supplier;", 1, 28);
        TYPES_0 = new Type[] { Type.TYPE_CLASS, Type.TYPE_STRING, Type.TYPE_STRING, Type.LONG_TYPE, Type.TYPE_LIST };
        TYPES_1 = new Type[] { Type.TYPE_JSON_WRITER, Type.TYPE_OBJECT, Type.TYPE_OBJECT, Type.TYPE_TYPE, Type.LONG_TYPE };
        TYPES_2 = new Type[] { Type.TYPE_CLASS, Type.TYPE_SUPPLIER, Type.TYPE_JSON_READER };
        TYPES_3 = new Type[] { Type.LONG_TYPE };
        TYPES_4 = new Type[] { Type.TYPE_JSON_READER, Type.TYPE_TYPE, Type.TYPE_OBJECT, Type.LONG_TYPE };
    }
}
