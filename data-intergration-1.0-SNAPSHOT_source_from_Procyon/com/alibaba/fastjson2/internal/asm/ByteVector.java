...
public class ByteVector
{
    ...
    public void putByteArray(final byte[] byteArrayValue, final int byteOffset, final int byteLength) {
    ...
    private void enlarge(final int size) {
        ...
        final byte[] newData = new byte[Math.max(doubleCapacity, minimalCapacity)];
