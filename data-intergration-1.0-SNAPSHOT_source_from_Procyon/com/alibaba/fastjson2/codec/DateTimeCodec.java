...
public abstract class DateTimeCodec
{
    ...
    public DateTimeCodec(final String format) {
        this(format, null);
    }
    
    public DateTimeCodec(String format, final Locale locale) {
        if (format != null) {
    ...
    public DateTimeFormatter getDateFormatter(final Locale locale) {
        ...
        if (this.locale == null) {
            return this.dateFormatter = DateTimeFormatter.ofPattern(this.format);
        }
        return this.dateFormatter = DateTimeFormatter.ofPattern(this.format, this.locale);
    }
}
