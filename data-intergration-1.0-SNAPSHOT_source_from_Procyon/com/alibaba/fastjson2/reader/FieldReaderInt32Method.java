...
{
    FieldReaderInt32Method(final String fieldName, final int ordinal, final long features, final String format, final Locale locale, final Integer defaultValue, final JSONSchema schema, final Method setter) {
