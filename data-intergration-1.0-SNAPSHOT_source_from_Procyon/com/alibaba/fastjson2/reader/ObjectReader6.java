...
public class ObjectReader6<T> extends ObjectReaderAdapter<T>
{
    ...
    ObjectReader6(final Class objectClass, final Supplier<T> creator, final long features, final JSONSchema schema, final Function buildFunction, final FieldReader fieldReader0, final FieldReader fieldReader1, final FieldReader fieldReader2, final FieldReader fieldReader3, final FieldReader fieldReader4, final FieldReader fieldReader5) {
        this(objectClass, null, null, features, schema, creator, buildFunction, (FieldReader[])new FieldReader[] { fieldReader0, fieldReader1, fieldReader2, fieldReader3, fieldReader4, fieldReader5 });
    }
    
    public ObjectReader6(final Class objectClass, final String typeKey, final String typeName, final long features, final Supplier<T> creator, final Function buildFunction, final FieldReader... fieldReaders) {
        this(objectClass, typeKey, typeName, features, null, creator, buildFunction, (FieldReader[])fieldReaders);
    }
    
    public ObjectReader6(final Class objectClass, final String typeKey, final String typeName, final long features, final JSONSchema schema, final Supplier<T> creator, final Function buildFunction, final FieldReader... fieldReaders) {
        ...
        if (!jsonReader.isArray()) {
            ...
            while (true) {
                while (!jsonReader.nextIfObjectEnd()) {
                    final long hashCode = jsonReader.readFieldNameHashCode();
                    Label_0704: {
                        if (i == 0 && hashCode == ObjectReader6.HASH_TYPE) {
