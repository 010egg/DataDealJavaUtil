...
{
    FieldReaderDoubleValueField(final String fieldName, final Class fieldType, final int ordinal, final long features, final String format, final Double defaultValue, final JSONSchema schema, final Field field) {
