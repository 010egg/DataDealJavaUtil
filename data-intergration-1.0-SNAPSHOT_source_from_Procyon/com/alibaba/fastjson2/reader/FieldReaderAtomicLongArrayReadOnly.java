...
{
    FieldReaderAtomicLongArrayReadOnly(final String fieldName, final Class fieldType, final int ordinal, final JSONSchema jsonSchema, final Method method) {
    ...
    public void accept(final T object, final Object value) {
        ...
        try {
            final AtomicLongArray atomic = (AtomicLongArray)this.method.invoke(object, new Object[0]);
            if (value instanceof AtomicLongArray) {
                final AtomicLongArray array = (AtomicLongArray)value;
