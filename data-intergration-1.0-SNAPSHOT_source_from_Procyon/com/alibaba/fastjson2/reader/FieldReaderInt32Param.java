...
{
    FieldReaderInt32Param(final String fieldName, final Class fieldType, final String paramName, final Parameter parameter, final int ordinal, final long features, final String format, final JSONSchema schema) {
