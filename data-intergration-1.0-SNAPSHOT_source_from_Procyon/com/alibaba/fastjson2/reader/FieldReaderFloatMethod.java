...
{
    FieldReaderFloatMethod(final String fieldName, final int ordinal, final long features, final String format, final Locale locale, final Float defaultValue, final JSONSchema schema, final Method setter) {
    ...
    public void readFieldValue(final JSONReader jsonReader, final T object) {
        final Float fieldValue = jsonReader.readFloat();
        if (this.schema != null) {
