...
final class FieldReaderInt64Func<T, V> extends FieldReader<T>
{
    ...
    public FieldReaderInt64Func(final String fieldName, final Class<V> fieldClass, final int ordinal, final long features, final String format, final Locale locale, final Object defaultValue, final JSONSchema schema, final Method method, final BiConsumer<T, V> function) {
