...
{
    FieldReaderInt8ValueMethod(final String fieldName, final Type fieldType, final Class fieldClass, final int ordinal, final long features, final String format, final Locale locale, final Byte defaultValue, final JSONSchema schema, final Method setter) {
    ...
    public void accept(final T object, final long value) {
        ...
        try {
            this.method.invoke(object, (byte)value);
        }
        catch (Exception e) {
            throw new JSONException("set " + this.fieldName + " error", e);
        }
