...
public class ObjectReader12<T> extends ObjectReaderAdapter<T>
{
    ...
    public ObjectReader12(final Class objectClass, final String typeKey, final String typeName, final long features, final Supplier<T> creator, final Function buildFunction, final FieldReader... fieldReaders) {
        this(objectClass, typeKey, typeName, features, null, creator, buildFunction, (FieldReader[])fieldReaders);
    }
    
    public ObjectReader12(final Class objectClass, final String typeKey, final String typeName, final long features, final JSONSchema schema, final Supplier<T> creator, final Function buildFunction, final FieldReader... fieldReaders) {
    ...
    public FieldReader getFieldReader(final long hashCode) {
        ...
        if (hashCode == this.hashCode9) {
            return this.fieldReader9;
        }
        if (hashCode == this.hashCode10) {
            return this.fieldReader10;
        }
        if (hashCode == this.hashCode11) {
    ...
    public FieldReader getFieldReaderLCase(final long hashCode) {
        ...
        if (hashCode == this.hashCode9LCase) {
            return this.fieldReader9;
        }
        if (hashCode == this.hashCode10LCase) {
            return this.fieldReader10;
        }
        if (hashCode == this.hashCode11LCase) {
            return this.fieldReader11;
        }
        return null;
    }
