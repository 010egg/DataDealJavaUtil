...
public class ObjectReader3<T> extends ObjectReaderAdapter<T>
{
    ...
    ObjectReader3(final Class objectClass, final Supplier<T> creator, final long features, final JSONSchema schema, final Function buildFunction, final FieldReader fieldReader0, final FieldReader fieldReader1, final FieldReader fieldReader2) {
        this(objectClass, null, null, features, schema, creator, buildFunction, (FieldReader[])new FieldReader[] { fieldReader0, fieldReader1, fieldReader2 });
    }
    
    public ObjectReader3(final Class objectClass, final String typeKey, final String typeName, final long features, final Supplier<T> creator, final Function buildFunction, final FieldReader... fieldReaders) {
        this(objectClass, typeKey, typeName, features, null, creator, buildFunction, (FieldReader[])fieldReaders);
    }
    
    public ObjectReader3(final Class objectClass, final String typeKey, final String typeName, final long features, final JSONSchema schema, final Supplier<T> creator, final Function buildFunction, final FieldReader... fieldReaders) {
        ...
        if (!jsonReader.isArray()) {
            ...
            while (true) {
                while (!jsonReader.nextIfObjectEnd()) {
                    ...
                    Label_0546: {
                        if (hashCode != 0L) {
                            if (i == 0 && hashCode == ObjectReader3.HASH_TYPE) {
