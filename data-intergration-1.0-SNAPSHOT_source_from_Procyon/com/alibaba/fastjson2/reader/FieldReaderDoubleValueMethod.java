...
{
    FieldReaderDoubleValueMethod(final String fieldName, final Type fieldType, final Class fieldClass, final int ordinal, final long features, final String format, final Locale locale, final Double defaultValue, final JSONSchema schema, final Method setter) {
    ...
    public void readFieldValue(final JSONReader jsonReader, final T object) {
        final double fieldValue = jsonReader.readDoubleValue();
        if (this.schema != null) {
