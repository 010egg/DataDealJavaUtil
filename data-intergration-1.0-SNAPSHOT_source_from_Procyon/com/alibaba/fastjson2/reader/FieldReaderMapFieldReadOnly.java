...
class FieldReaderMapFieldReadOnly<T> extends FieldReaderObjectField<T>
{
    FieldReaderMapFieldReadOnly(final String fieldName, final Type fieldType, final Class fieldClass, final int ordinal, final long features, final String format, final JSONSchema schema, final Field field) {
    ...
    public void processExtra(final JSONReader jsonReader, final Object object) {
        ...
        final Object value = itemObjectReader.readObject(jsonReader, null, name, 0L);
        map.put(name, value);
    }
