...
{
    FieldReaderInt16Method(final String fieldName, final Type fieldType, final Class fieldClass, final int ordinal, final long features, final String format, final Locale locale, final Short defaultValue, final JSONSchema schema, final Method setter) {
    ...
    public void readFieldValue(final JSONReader jsonReader, final T object) {
        ...
        try {
            this.method.invoke(object, (fieldValue == null) ? null : Short.valueOf(fieldValue.shortValue()));
        }
        catch (Exception e) {
