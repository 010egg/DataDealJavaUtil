...
final class FieldReaderInt8Func<T, V> extends FieldReader<T>
{
    ...
    FieldReaderInt8Func(final String fieldName, final Class<V> fieldClass, final int ordinal, final long features, final String format, final Locale locale, final Object defaultValue, final JSONSchema schema, final Method method, final BiConsumer<T, V> function) {
    ...
    public void readFieldValue(final JSONReader jsonReader, final T object) {
        ...
        try {
            ...
            fieldValue = ((value == null) ? null : Byte.valueOf(value.byteValue()));
        }
        catch (Exception e) {
