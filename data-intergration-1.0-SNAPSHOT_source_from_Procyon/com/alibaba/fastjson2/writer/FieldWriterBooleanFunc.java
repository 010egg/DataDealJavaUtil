...
final class FieldWriterBooleanFunc extends FieldWriterBoolean
{
    ...
    FieldWriterBooleanFunc(final String fieldName, final int ordinal, final long features, final String format, final String label, final Field field, final Method method, final Function function) {
