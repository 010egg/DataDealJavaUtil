            ...
            for (final String item : split) {
                if (item != null && item.length() > 0) {
                    try {
                        ...
                        OceanBaseOracleExceptionSorter.LOG.error("parse druid.oracle.fatalErrorCodes error", e);
                    }
                }
            }
        }
    ...
    public boolean isExceptionFatal(final SQLException e) {
        ...
        switch (error_code) {
            ...
            default: {
                ...
                return ((error_code < 20000 || error_code >= 21000) && (error_text.contains("SOCKET") || error_text.contains("\u5957\u63a5\u5b57") || error_text.contains("CONNECTION HAS ALREADY BEEN CLOSED") || error_text.contains("BROKEN PIPE") || error_text.contains("\u7ba1\u9053\u5df2\u7ed3\u675f"))) || (error_text.indexOf("COMMUNICATIONS LINK FAILURE") > -1 || error_text.indexOf("COULD NOT CREATE CONNECTION") > -1 || error_text.indexOf("ACCESS DENIED FOR USER") > -1 || error_text.indexOf("NO DATASOURCE") > -1 || error_text.indexOf("NO ALIVE DATASOURCE") > -1) || this.fatalErrorCodes.contains(error_code);
            }
        }
    }
