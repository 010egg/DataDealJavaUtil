...
public class WallTableStatValue
{
    ...
    public WallTableStatValue(final String name) {
        this.name = name;
    }
    ...
    public void setSelectCount(final long selectCount) {
    ...
    public void setSelectIntoCount(final long selectIntoCount) {
    ...
    public void setInsertCount(final long insertCount) {
    ...
    public void setDeleteCount(final long deleteCount) {
    ...
    public void setTruncateCount(final long truncateCount) {
    ...
    public void setCreateCount(final long createCount) {
    ...
    public void setAlterCount(final long alterCount) {
    ...
    public void setDropCount(final long dropCount) {
    ...
    public void setReplaceCount(final long replaceCount) {
    ...
    public void setDeleteDataCount(final long deleteDataCount) {
    ...
    public void setUpdateDataCount(final long updateDataCount) {
    ...
    public void setInsertDataCount(final long insertDataCount) {
