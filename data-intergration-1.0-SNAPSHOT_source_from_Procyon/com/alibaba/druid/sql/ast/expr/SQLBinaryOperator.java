...
public enum SQLBinaryOperator
{
    ...
    public static int getPriority(final SQLBinaryOperator operator) {
        return 0;
    }
    
    private SQLBinaryOperator(final String name, final int priority) {
        this.name = name;
    ...
    public boolean isLogical() {
        return this == SQLBinaryOperator.BooleanAnd || this == SQLBinaryOperator.BooleanOr || this == SQLBinaryOperator.BooleanXor;
    }
