...
public class SQLDateTimeExpr extends SQLExprImpl implements SQLLiteralExpr, SQLValuableExpr, SQLReplaceable
{
    ...
    public SQLDateTimeExpr(final Date now, final TimeZone timeZone) {
    ...
    public SQLDateTimeExpr(final String literal) {
    ...
    public SQLDataType computeDataType() {
        return SQLDateTimeExpr.DATA_TYPE;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final SQLDateTimeExpr other = (SQLDateTimeExpr)obj;
    ...
    public SQLDateTimeExpr clone() {
        final SQLDateTimeExpr x = new SQLDateTimeExpr();
        if (this.literal != null) {
    ...
    public static boolean isSupport(final DbType dbType) {
        return (dbType.mask & SQLDateTimeExpr.supportDbTypes) != 0x0L;
    }
    ...
    static {
        DATA_TYPE = new SQLDataTypeImpl("datetime");
        SQLDateTimeExpr.supportDbTypes = DbType.of(DbType.mysql, DbType.oracle, DbType.presto, DbType.trino, DbType.postgresql);
    }
}
