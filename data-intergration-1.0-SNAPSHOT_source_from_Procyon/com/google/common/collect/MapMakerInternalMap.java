...
class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable
{
    ...
    {
        StrongKeyDummyValueEntry(final K key, final int hash, @Nullable final StrongKeyDummyValueEntry<K> next) {
            super(key, hash, next);
        }
        ...
        static final class Helper<K> implements InternalEntryHelper<K, MapMaker.Dummy, StrongKeyDummyValueEntry<K>, StrongKeyDummyValueSegment<K>>
        {
            ...
            @Override
            public StrongKeyDummyValueEntry<K> copy(final StrongKeyDummyValueSegment<K> segment, final StrongKeyDummyValueEntry<K> entry, @Nullable final StrongKeyDummyValueEntry<K> newNext) {
                return entry.copy(newNext);
            }
            ...
            @Override
            public StrongKeyDummyValueEntry<K> newEntry(final StrongKeyDummyValueSegment<K> segment, final K key, final int hash, @Nullable final StrongKeyDummyValueEntry<K> next) {
    ...
    {
        WeakKeyDummyValueEntry(final ReferenceQueue<K> queue, final K key, final int hash, @Nullable final WeakKeyDummyValueEntry<K> next) {
        ...
        static final class Helper<K> implements InternalEntryHelper<K, MapMaker.Dummy, WeakKeyDummyValueEntry<K>, WeakKeyDummyValueSegment<K>>
        {
            ...
            @Override
            public WeakKeyDummyValueEntry<K> copy(final WeakKeyDummyValueSegment<K> segment, final WeakKeyDummyValueEntry<K> entry, @Nullable final WeakKeyDummyValueEntry<K> newNext) {
                if (entry.getKey() == null) {
                    return null;
                }
            ...
            @Override
            public WeakKeyDummyValueEntry<K> newEntry(final WeakKeyDummyValueSegment<K> segment, final K key, final int hash, @Nullable final WeakKeyDummyValueEntry<K> next) {
