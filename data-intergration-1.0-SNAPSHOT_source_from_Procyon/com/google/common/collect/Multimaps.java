...
public final class Multimaps
{
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable
    {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            if (result == null) {
                final Map<Object, Object> unmodifiableMap = Collections.unmodifiableMap((Map<?, ?>)Maps.transformValues((Map<? extends K, Collection<V>>)this.delegate.asMap(), (com.google.common.base.Function<? super Collection<V>, ? extends V>)new com.google.common.base.Function<Collection<V>, Collection<V>>() {
                    @Override
