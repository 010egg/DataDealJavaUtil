...
public class FileResource extends Resource
{
    ...
    public FileResource(final URL url) throws IOException, URISyntaxException {
        ...
        this._alias = checkFileAlias(this._file);
    }
    ...
    public FileResource(final URI uri) {
        ...
        this.assertValidPath(file.toString());
        if (!URIUtil.equalsIgnoreEncodings(this._uri, file_uri.toString())) {
    ...
    private static String normalizeURI(final File file, final URI uri) {
    ...
    private static URI checkFileAlias(final File file) {
        try {
    ...
    public Resource addPath(String path) throws IOException, MalformedURLException {
        ...
        try {
            if (this._file.isDirectory()) {
                uri = new URI(URIUtil.addPaths(this._uri, path));
            }
            else {
                uri = new URI(this._uri + path);
            }
        }
        catch (URISyntaxException e) {
