...
public class ScheduledExecutorScheduler extends AbstractLifeCycle implements Scheduler, Dumpable
{
    ...
    protected void doStart() throws Exception {
        (this.scheduler = new ScheduledThreadPoolExecutor(1, new ThreadFactory() {
            ...
            public Thread newThread(final Runnable r) {
                final Thread thread = ScheduledExecutorScheduler.this.thread = new Thread(r, ScheduledExecutorScheduler.this.name);
    ...
    private class ScheduledFutureTask implements Task
    {
        ...
        public ScheduledFutureTask(final ScheduledFuture<?> scheduledFuture) {
