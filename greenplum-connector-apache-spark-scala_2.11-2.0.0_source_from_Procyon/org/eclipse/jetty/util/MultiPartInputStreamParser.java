...
public class MultiPartInputStreamParser
{
    ...
    protected void parse() throws IOException, ServletException {
        ...
        final byte[] byteBoundary = (boundary + "--").getBytes(StandardCharsets.ISO_8859_1);
        String line = null;
        try {
        ...
        for (line = line.trim(); line != null && !line.equals(boundary); line = ((ReadLineInputStream)this._in).readLine(), line = ((line == null) ? line : line.trim())) {
            if (!badFormatLogged) {
                MultiPartInputStreamParser.LOG.warn("Badly formatted multipart request", new Object[0]);
    ...
    public class MultiPart implements Part
    {
        ...
        public void write(final String fileName) throws IOException {
            if (this._file == null) {
                ...
                this._temporary = false;
                final File f = new File(MultiPartInputStreamParser.this._tmpDir, fileName);
