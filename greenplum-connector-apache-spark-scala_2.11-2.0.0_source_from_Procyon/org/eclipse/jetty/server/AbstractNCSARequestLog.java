...
public abstract class AbstractNCSARequestLog extends AbstractLifeCycle implements RequestLog
{
    ...
    public void log(final Request request, final Response response) {
        try {
            ...
            final long responseLength = response.getLongContentLength();
    ...
    protected void logExtended(final Request request, final Response response, final StringBuilder b) throws IOException {
