        ...
        if (filled == 0) {
            if (this.protocol == null) {
                ...
                if (connectionFactory == null) {
                    if (NegotiatingServerConnection.LOG.isDebugEnabled()) {
                        NegotiatingServerConnection.LOG.debug("{} application selected protocol '{}', but no correspondent {} has been configured", this, this.protocol, ConnectionFactory.class.getName());
                    }
                    this.close();
                }
                else {
            ...
            if (NegotiatingServerConnection.LOG.isDebugEnabled()) {
                NegotiatingServerConnection.LOG.debug("{} closing on client close", this);
            }
            this.close();
        }
    }
