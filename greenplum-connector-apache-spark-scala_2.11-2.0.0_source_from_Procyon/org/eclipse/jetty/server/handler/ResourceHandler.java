...
public class ResourceHandler extends HandlerWrapper
{
    ...
    public ResourceHandler() {
        ...
        this._minMemoryMappedContentLength = 1024;
        this._minAsyncContentLength = 0;
    }
    ...
    public Resource getResource(String path) throws MalformedURLException {
        ...
        if (base == null) {
            ...
            try {
                ...
                if (r != null && r.getAlias() != null && (this._context == null || !this._context.checkAlias(path, r))) {
                    if (ResourceHandler.LOG.isDebugEnabled()) {
    ...
    public void handle(final String target, final Request baseRequest, final HttpServletRequest request, final HttpServletResponse response) throws IOException, ServletException {
        ...
        if (!(out instanceof HttpOutput)) {
            ...
            if (request.isAsyncSupported() && min_async_size > 0 && resource.length() >= min_async_size) {
                ...
                if (this._minMemoryMappedContentLength > 0 && resource.length() > this._minMemoryMappedContentLength && resource.length() < 2147483647L && resource instanceof FileResource) {
            ...
            else if (this._minMemoryMappedContentLength > 0 && resource.length() > this._minMemoryMappedContentLength && resource instanceof FileResource) {
