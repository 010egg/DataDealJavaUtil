...
public class ContextHandler extends ScopedHandler implements Attributes, Graceful
{
    ...
    private final List<ServletContextListener> _contextListeners;
    private final List<ServletContextAttributeListener> _contextAttributeListeners;
    private final List<ServletRequestListener> _requestListeners;
    ...
    public ContextHandler() {
        ...
        this._contextListeners = new CopyOnWriteArrayList<ServletContextListener>();
        this._contextAttributeListeners = new CopyOnWriteArrayList<ServletContextAttributeListener>();
        this._requestListeners = new CopyOnWriteArrayList<ServletRequestListener>();
        this._requestAttributeListeners = new CopyOnWriteArrayList<ServletRequestAttributeListener>();
    ...
    public void dump(final Appendable out, final String indent) throws IOException {
        this.dumpBeans(out, indent, Collections.singletonList(new ClassLoaderDump(this.getClassLoader())), this._initParams.entrySet(), this._attributes.getAttributeEntrySet(), this._scontext.getAttributeEntrySet());
    }
    ...
    public void addEventListener(final EventListener listener) {
        ...
        if (listener instanceof ServletContextAttributeListener) {
            this._contextAttributeListeners.add((ServletContextAttributeListener)listener);
        }
        if (listener instanceof ServletRequestListener) {
            this._requestListeners.add((ServletRequestListener)listener);
        }
    ...
    public void removeEventListener(final EventListener listener) {
        ...
        if (listener instanceof ServletRequestListener) {
            this._requestListeners.remove(listener);
        }
        if (listener instanceof ServletRequestAttributeListener) {
    ...
    protected void startContext() throws Exception {
        ...
        if (managedAttributes != null) {
            ...
            final String[] arr$;
            final String[] attributes = arr$ = managedAttributes.split(",");
            for (final String attribute : arr$) {
                this._managedAttributes.put(attribute.trim(), null);
            }
            final Enumeration<String> e = this._scontext.getAttributeNames();
        ...
        if (!this._contextListeners.isEmpty()) {
            ...
            for (final ServletContextListener listener : this._contextListeners) {
    ...
    protected void doStop() throws Exception {
        ...
        try {
            ...
            if (!this._contextListeners.isEmpty()) {
                ...
                while (i-- > 0) {
                    this.callContextDestroyed(this._contextListeners.get(i), event);
                }
            }
        ...
        try {
            if (new_context) {
                ...
                if (!this._requestListeners.isEmpty()) {
                    ...
                    for (final ServletRequestListener i : this._requestListeners) {
            ...
            if (new_context) {
                if (!this._requestListeners.isEmpty()) {
                    ...
                    int j = this._requestListeners.size();
                    while (j-- > 0) {
                        this._requestListeners.get(j).requestDestroyed(sre2);
                    }
                }
                if (!this._requestAttributeListeners.isEmpty()) {
                    int k = this._requestAttributeListeners.size();
                    while (k-- > 0) {
                        baseRequest.removeEventListener(this._requestAttributeListeners.get(k));
                    }
                }
            }
        }
    ...
    public void setAttributes(final Attributes attributes) {
        ...
        final Enumeration<String> e = this._attributes.getAttributeNames();
        while (e.hasMoreElements()) {
            final String name = e.nextElement();
    ...
    public void checkManagedAttribute(final String name, final Object value) {
    ...
    public class Context extends NoContext
    {
        ...
        public RequestDispatcher getRequestDispatcher(String uriInContext) {
            ...
            try {
                ...
                if (pathInContext != null) {
                    ...
                    final ContextHandler context = ContextHandler.this;
        ...
        public synchronized void setAttribute(final String name, final Object value) {
            ...
            if (!ContextHandler.this._contextAttributeListeners.isEmpty()) {
                ...
                for (final ServletContextAttributeListener l : ContextHandler.this._contextAttributeListeners) {
                    if (old_value == null) {
        ...
        public synchronized void removeAttribute(final String name) {
            ...
            final Object old_value = super.getAttribute(name);
            super.removeAttribute(name);
            if (old_value != null && !ContextHandler.this._contextAttributeListeners.isEmpty()) {
    ...
    public static class ApproveSameSuffixAliases implements AliasCheck
    {
        ...
        @Override
        public boolean check(final String path, final Resource resource) {
            final int dot = path.lastIndexOf(46);
            if (dot < 0) {
                return false;
            }
            final String suffix = path.substring(dot);
    ...
    public static class ApprovePathPrefixAliases implements AliasCheck
    {
        ...
        public boolean check(final String path, final Resource resource) {
            ...
            final String suffix = path.substring(slash);
            return resource.toString().endsWith(suffix);
        }
    }
    ...
    public static class ApproveNonExistentDirectoryAliases implements AliasCheck
    {
        ...
        public boolean check(final String path, final Resource resource) {
            ...
            final String r = resource.getURL().toString();
