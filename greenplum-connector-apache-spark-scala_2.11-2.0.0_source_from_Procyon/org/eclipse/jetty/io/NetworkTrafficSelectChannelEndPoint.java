...
public class NetworkTrafficSelectChannelEndPoint extends SelectChannelEndPoint
{
    ...
    public NetworkTrafficSelectChannelEndPoint(final SocketChannel channel, final SelectorManager.ManagedSelector selectSet, final SelectionKey key, final Scheduler scheduler, final long idleTimeout, final List<NetworkTrafficListener> listeners) throws IOException {
