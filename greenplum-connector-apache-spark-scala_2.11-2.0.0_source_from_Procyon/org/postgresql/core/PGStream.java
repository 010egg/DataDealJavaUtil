...
public class PGStream implements Closeable, Flushable
{
    ...
    public PGStream(final SocketFactory socketFactory, final HostSpec hostSpec, final int timeout) throws IOException {
        ...
        if (!socket.isConnected()) {
            final InetSocketAddress address = hostSpec.shouldResolve() ? new InetSocketAddress(hostSpec.getHost(), hostSpec.getPort()) : InetSocketAddress.createUnresolved(hostSpec.getHost(), hostSpec.getPort());
