...
public class PGPoolingDataSource extends BaseDataSource implements DataSource
{
    ...
    private Stack<PooledConnection> available;
    private Stack<PooledConnection> used;
    private Object lock;
    ...
    public String getDescription() {
        return "Pooling DataSource '" + this.dataSourceName + " from " + "PostgreSQL JDBC Driver 42.2.14";
    }
