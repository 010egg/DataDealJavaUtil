...
public class PgDatabaseMetaData implements DatabaseMetaData
{
    ...
    public ResultSet getTablePrivileges(final String catalog, final String schemaPattern, final String tableNamePattern) throws SQLException {
        ...
        String sql = "SELECT n.nspname,c.relname,r.rolname,c.relacl  FROM pg_catalog.pg_namespace n, pg_catalog.pg_class c, pg_catalog.pg_roles r  WHERE c.relnamespace = n.oid  AND c.relowner = r.oid  AND c.relkind IN ('r','p') ";
        if (schemaPattern != null && !schemaPattern.isEmpty()) {
            sql = sql + " AND n.nspname LIKE " + this.escapeQuotes(schemaPattern);
        }
        if (tableNamePattern != null && !tableNamePattern.isEmpty()) {
        ...
        for (int i = 0; i < privs.length(); ++i) {
            ...
            if (c != '*') {
                ...
                if (usersWithPermission == null) {
                    ...
                    final List<String[]> permissionByGrantor = new ArrayList<String[]>();
    ...
    public ResultSet getTypeInfo() throws SQLException {
        ...
        Collections.sort(v, new Comparator<Tuple>() {
            ...
            public int compare(final Tuple o1, final Tuple o2) {
                final int i1 = ByteConverter.bytesToInt(o1.get(18));
                final int i2 = ByteConverter.bytesToInt(o2.get(18));
