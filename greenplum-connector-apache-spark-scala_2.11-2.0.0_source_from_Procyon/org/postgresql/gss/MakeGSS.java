...
public class MakeGSS
{
    ...
    public static void authenticate(final PGStream pgStream, final String host, final String user, final String password, String jaasApplicationName, String kerberosServerName, final boolean useSpnego, final boolean jaasLogin, final boolean logServerErrorDetail) throws IOException, SQLException {
