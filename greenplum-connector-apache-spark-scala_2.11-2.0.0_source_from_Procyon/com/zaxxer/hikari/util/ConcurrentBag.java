...
public class ConcurrentBag<T extends IConcurrentBagEntry> implements AutoCloseable
{
    ...
    public T borrow(long timeout, final TimeUnit timeUnit) throws InterruptedException {
        ...
        try {
            ...
            do {
                ...
                final T bagEntry2 = this.handoffQueue.poll(timeout, TimeUnit.NANOSECONDS);
    ...
    public void requite(final T bagEntry) {
        ...
        final List<Object> threadLocalList = this.threadList.get();
    ...
    public boolean remove(final T bagEntry) {
        ...
        final boolean removed = this.sharedList.remove(bagEntry);
    ...
    public List<T> values(final int state) {
        final List<T> list = this.sharedList.stream().filter(e -> e.getState() == state).collect((Collector<? super Object, ?, List<T>>)Collectors.toList());
