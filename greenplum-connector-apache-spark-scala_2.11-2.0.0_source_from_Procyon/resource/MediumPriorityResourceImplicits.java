...
public interface MediumPriorityResourceImplicits extends LowPriorityResourceImplicits
{
    ...
    gzipOuputStraemResource$ gzipOuputStraemResource();
    
    jarFileResource$ jarFileResource();
    
    HttpURLConnectionResource$ HttpURLConnectionResource();
    
    public class gzipOuputStraemResource$ implements Resource<GZIPOutputStream>
    {
        @Override
        public void open(final Object r) {
            Resource$class.open(this, r);
        }
        
        @Override
        public void closeAfterException(final Object r, final Throwable t) {
            Resource$class.closeAfterException(this, r, t);
        }
        
        @Override
        public boolean isFatalException(final Throwable t) {
            return Resource$class.isFatalException(this, t);
        }
        
        @Override
        public boolean isRethrownException(final Throwable t) {
            return Resource$class.isRethrownException(this, t);
        }
        
        @Override
        public void close(final GZIPOutputStream r) {
            r.finish();
        }
        ...
        public gzipOuputStraemResource$(final MediumPriorityResourceImplicits $outer) {
    ...
    public class jarFileResource$ implements Resource<JarFile>
    {
        ...
        @Override
        public void close(final JarFile r) {
            r.close();
        }
        ...
        public jarFileResource$(final MediumPriorityResourceImplicits $outer) {
            Resource$class.$init$(this);
        }
    }
    ...
    public class HttpURLConnectionResource$ implements Resource<HttpURLConnection>
    {
        ...
        @Override
        public void close(final HttpURLConnection c) {
            c.disconnect();
        }
        ...
        public HttpURLConnectionResource$(final MediumPriorityResourceImplicits $outer) {
            Resource$class.$init$(this);
        }
    }
}
