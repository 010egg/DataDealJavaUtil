...
{
    void open(final R p0);
    
    void close(final R p0);
    
    void closeAfterException(final R p0, final Throwable p1);
    
    boolean isFatalException(final Throwable p0);
    
    boolean isRethrownException(final Throwable p0);
}
