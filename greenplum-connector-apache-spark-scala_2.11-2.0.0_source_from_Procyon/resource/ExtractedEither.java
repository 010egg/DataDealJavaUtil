...
public class ExtractedEither<A, B> implements Product, Serializable
{
    private final Either<A, B> either;
    
    public static <A, B> Option<Either<A, B>> unapply(final ExtractedEither<A, B> x$0) {
        return ExtractedEither$.MODULE$.unapply(x$0);
    }
    
    public static <A, B> ExtractedEither<A, B> apply(final Either<A, B> either) {
    ...
    public <A, B> ExtractedEither<A, B> copy(final Either<A, B> either) {
    ...
    public boolean equals(final Object x$1) {
        if (this != x$1) {
            if (x$1 instanceof ExtractedEither) {
                final ExtractedEither extractedEither = (ExtractedEither)x$1;
                final Either<A, B> either = this.either();
                final Either either2 = extractedEither.either();
                boolean b = false;
                Label_0077: {
                    Label_0076: {
                        if (either == null) {
                        ...
                        if (extractedEither.canEqual(this)) {
                            b = true;
                            break Label_0077;
                        }
                    }
    ...
    public ExtractedEither(final Either<A, B> either) {
        this.either = either;
